...
import { closeSession, createSession } from "../../../app/adminSlice";
      ...
      <Dialog open={closeDialog} onClose={() => setCloseDialog(false)}>
        <Stack padding="1.5rem">
          <Typography fontSize={"20px"}>
            <p className=" text-white">Are you sure you want to create new session?</p>
          </Typography>
          <Stack
            direction={"row"}
            marginTop={"1rem"}
          ...
          >
            ...
            <Button variant="contained" onClick={() => setCloseDialog(false)} >
              Cancel{" "}
            </Button>
          </Stack>
        </Stack>
